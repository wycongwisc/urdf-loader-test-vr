...
pub struct Arm {
    ...
    rot_offsets: Vec<Vec<f64>>,
    rot_offset_matrices: Vec<nalgebra::Matrix3<f64>>,
    rot_offset_quats: Vec<nalgebra::UnitQuaternion<f64>>,
    joint_types: Vec<String>,
    num_dof: usize,
    out_positions: Vec<nalgebra::Vector3<f64>>,
    out_rot_mats: Vec<nalgebra::Matrix3<f64>>,
    out_rot_quats: Vec<nalgebra::UnitQuaternion<f64>>,
    // pub axis_types: Vec<String>,
    // pub displacements: Vec<nalgebra::Vector3<f64>>,
    // pub disp_offset: nalgebra::Vector3<f64>,
...
//         rot_offsets: Vec<Vec<f64>>, joint_types: Vec<String>

impl Arm{
    pub fn new( config: ArmConstructorData) -> Arm {
        let axis_types = config.axis_types;
        let displacements = config.displacements;
        let disp_offset = config.disp_offset;
        let rot_offsets = config.rot_offsets;
        let joint_types = config.joint_types;
