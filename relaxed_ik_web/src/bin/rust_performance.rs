extern crate relaxed_ik_web_lib;
use relaxed_ik_web_lib::relaxed_ik_web;
use relaxed_ik_web_lib::utils_rust::subscriber_utils::EEPoseGoalsSubscriber;
...
// println!("{} seconds for whatever you did.", start.to(end));
    ...
    let mut r = relaxed_ik_web::RelaxedIK::from_info_file_name(format!("{}_info.yaml", name), 1);
