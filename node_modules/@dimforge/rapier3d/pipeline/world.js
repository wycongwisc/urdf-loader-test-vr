...
export class World {
     ...
     *   project on colliders with collision groups compatible with the ray's group.
     */
    projectPointAndGetFeature(point, groups, filter) {
        return this.queryPipeline.projectPointAndGetFeature(this.colliders, point, groups, castClosure(this.colliders, filter));
    }
    /**
