...
export default class TeleportVR {
    constructor(scene, camera) {
        ...
        const _mesh2 = new THREE.Mesh(new THREE.BoxBufferGeometry(0.03, 0.03, 1), new THREE.MeshBasicMaterial({
            color: 0xffffff,
            wireframe: false,
        }));
        _mesh2.translateZ(-.5);
    ...
    update(elevationsMeshList) {
        ...
        if (this._visible) {
            ...
            midPoint.translateY(-this._target.position.distanceTo(this._activeController.position) / 2);
